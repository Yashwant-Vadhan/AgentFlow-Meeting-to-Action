"""
audio_preprocess.py — TV-001/TV-002: Audio preprocessing & chunking.

TV-001 — preprocess_audio():
  • Loads raw audio (.wav/.mp3/.m4a) via pydub
  ...
  • Writes cleaned audio to a new file, returns its path
...
def preprocess_audio(input_path: str) -> str:
    """
    Preprocess raw audio: normalize volume, apply noise reduction, high-pass filter.
